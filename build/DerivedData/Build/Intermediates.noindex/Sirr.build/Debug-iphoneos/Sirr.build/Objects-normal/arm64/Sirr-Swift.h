...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Sirr",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Sirr22AppleSignInCoordinator")
@interface AppleSignInCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASAuthorizationController;
@interface AppleSignInCoordinator (SWIFT_EXTENSION(Sirr)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface AppleSignInCoordinator (SWIFT_EXTENSION(Sirr)) <ASAuthorizationControllerDelegate>
...
@class CLLocation;
SWIFT_CLASS("_TtC4Sirr23LocationManagerDelegate")
...
SWIFT_CLASS("_TtC4Sirr14PaymentService")
...
@interface PaymentService (SWIFT_EXTENSION(Sirr)) <PKPaymentAuthorizationControllerDelegate>
