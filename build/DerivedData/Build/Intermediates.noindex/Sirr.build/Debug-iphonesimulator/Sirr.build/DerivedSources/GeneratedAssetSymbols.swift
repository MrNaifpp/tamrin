...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let riyal = DeveloperToolsSupport.ImageResource(name: "riyal", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "riyal" asset catalog image.
    static var riyal: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .riyal)
#else
        .init()
...
extension UIKit.UIImage {
    ...
    /// The "riyal" asset catalog image.
    static var riyal: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .riyal)
#else
        .init()
